...
public final class WinterCampGetRecvItemListRspOuterClass {
  ...
  public interface WinterCampGetRecvItemListRspOrBuilder extends
    ...
    /**
     * <code>repeated .WinterCampRecvItemData recv_item_data_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int RECV_ITEM_DATA_LIST_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < recvItemDataList_.size(); i++) {
        output.writeMessage(1, recvItemDataList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < recvItemDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, recvItemDataList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t\030\001 \003(\0132\027.WinterCampRecvItemData\022\017\n\007retc" +
