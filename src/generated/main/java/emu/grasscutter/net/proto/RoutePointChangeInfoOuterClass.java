...
public final class RoutePointChangeInfoOuterClass {
  ...
  public interface RoutePointChangeInfoOrBuilder extends
    ...
    /**
     * <code>uint32 point_index = 12;</code>
     * @return The pointIndex.
     */
    int getPointIndex();

    /**
     * <code>float target_velocity = 2;</code>
     * @return The targetVelocity.
     */
    float getTargetVelocity();

    /**
     * <code>float wait_time = 11;</code>
     * @return The waitTime.
     */
    float getWaitTime();
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int POINT_INDEX_FIELD_NUMBER = 12;
    ...
    public static final int TARGET_VELOCITY_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (targetVelocity_ != 0F) {
        output.writeFloat(2, targetVelocity_);
      }
      if (waitTime_ != 0F) {
        output.writeFloat(11, waitTime_);
      }
      if (pointIndex_ != 0) {
        output.writeUInt32(12, pointIndex_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (targetVelocity_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(2, targetVelocity_);
      }
      if (waitTime_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(11, waitTime_);
      }
      if (pointIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, pointIndex_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ntChangeInfo\022\023\n\013point_index\030\014 \001(\r\022\027\n\017tar" +
      "get_velocity\030\002 \001(\002\022\021\n\twait_time\030\013 \001(\002B\033\n" +
