...
public final class AvatarExpeditionStartRspOuterClass {
  ...
  public interface AvatarExpeditionStartRspOrBuilder extends
    ...
    /**
     * <pre>
     * repeated int32 BPCNBAPKDEL = 10;
     * </pre>
     *
     * <code>repeated .AvatarExpeditionBasicInfo expedition_basic_info_list = 12;</code>
     */
     ...
     * <code>repeated .AvatarExpeditionBasicInfo expedition_basic_info_list = 12;</code>
     */
    emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo getExpeditionBasicInfoList(int index);
    /**
     * <pre>
     * repeated int32 BPCNBAPKDEL = 10;
     * </pre>
     ...
     * <code>repeated .AvatarExpeditionBasicInfo expedition_basic_info_list = 12;</code>
     */
    emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfoOrBuilder getExpeditionBasicInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 98: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                expeditionBasicInfoList_ = new java.util.ArrayList<emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo>();
    ...
    public static final int EXPEDITION_BASIC_INFO_LIST_FIELD_NUMBER = 12;
    private java.util.List<emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo> expeditionBasicInfoList_;
    /**
     * <pre>
     * repeated int32 BPCNBAPKDEL = 10;
     * </pre>
     ...
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo> getExpeditionBasicInfoListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo getExpeditionBasicInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfoOrBuilder getExpeditionBasicInfoListOrBuilder(
        int index) {
      return expeditionBasicInfoList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < expeditionBasicInfoList_.size(); i++) {
        output.writeMessage(12, expeditionBasicInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < expeditionBasicInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, expeditionBasicInfoList_.get(i));
      }
    ...
    public int hashCode() {
      ...
      if (getExpeditionBasicInfoListCount() > 0) {
        hash = (37 * hash) + EXPEDITION_BASIC_INFO_LIST_FIELD_NUMBER;
    ...
    public static final class Builder extends
      ...
      private void ensureExpeditionBasicInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          expeditionBasicInfoList_ = new java.util.ArrayList<emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo>(expeditionBasicInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo, emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo.Builder, emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfoOrBuilder> expeditionBasicInfoListBuilder_;
       ...
       * <code>repeated .AvatarExpeditionBasicInfo expedition_basic_info_list = 12;</code>
       */
      public Builder addExpeditionBasicInfoList(emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo value) {
        if (expeditionBasicInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .AvatarExpeditionBasicInfo expedition_basic_info_list = 12;</code>
       */
      public emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo.Builder getExpeditionBasicInfoListBuilder(
          int index) {
       ...
       * <code>repeated .AvatarExpeditionBasicInfo expedition_basic_info_list = 12;</code>
       */
      public emu.grasscutter.net.proto.AvatarExpeditionBasicInfoOuterClass.AvatarExpeditionBasicInfo.Builder addExpeditionBasicInfoListBuilder() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\036AvatarExpeditionStartRsp.proto\032\037Avatar" +
      "ExpeditionBasicInfo.proto\032\032AvatarExpedit" +
      "ionInfo.proto\"\213\002\n\030AvatarExpeditionStartR" +
      "sp\022M\n\023expedition_info_map\030\017 \003(\01320.Avatar" +
      "ExpeditionStartRsp.ExpeditionInfoMapEntr" +
      "y\022>\n\032expedition_basic_info_list\030\014 \003(\0132\032." +
      "AvatarExpeditionBasicInfo\022\017\n\007retcode\030\t \001" +
    ...
    internal_static_AvatarExpeditionStartRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AvatarExpeditionStartRsp_descriptor,
        new java.lang.String[] { "ExpeditionInfoMap", "ExpeditionBasicInfoList", "Retcode", });
    internal_static_AvatarExpeditionStartRsp_ExpeditionInfoMapEntry_descriptor =
