...
public final class ScenePlayInfoListNotifyOuterClass {
  ...
  public interface ScenePlayInfoListNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .ScenePlayInfo play_info_list = 14;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PLAY_INFO_LIST_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < playInfoList_.size(); i++) {
        output.writeMessage(14, playInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < playInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, playInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "&\n\016play_info_list\030\016 \003(\0132\016.ScenePlayInfoB" +
