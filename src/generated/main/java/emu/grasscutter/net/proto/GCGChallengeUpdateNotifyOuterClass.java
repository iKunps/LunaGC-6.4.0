...
public final class GCGChallengeUpdateNotifyOuterClass {
  ...
  public interface GCGChallengeUpdateNotifyOrBuilder extends
    ...
    /**
     * <code>.GCGDuelChallenge challenge = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (challenge_ != null) {
        output.writeMessage(6, getChallenge());
      }
      if (serverSeq_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (challenge_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, getChallenge());
      }
      if (serverSeq_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tify\022$\n\tchallenge\030\006 \001(\0132\021.GCGDuelChallen" +
