...
public final class FurnitureMakeMakeInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MAKE_COUNT_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (makeCount_ != 0) {
        output.writeUInt32(1, makeCount_);
      }
      if (furnitureId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (makeCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, makeCount_);
      }
      if (furnitureId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "reMakeMakeInfo\022\022\n\nmake_count\030\001 \001(\r\022\024\n\014fu" +
      "rniture_id\030\003 \001(\rB\033\n\031emu.grasscutter.net." +
      "protob\006proto3"
    };
