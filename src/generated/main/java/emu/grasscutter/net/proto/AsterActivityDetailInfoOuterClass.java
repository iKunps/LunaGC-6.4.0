...
public final class AsterActivityDetailInfoOuterClass {
  ...
  public interface AsterActivityDetailInfoOrBuilder extends
    ...
    /**
     * <code>.AsterLargeDetailInfo aster_large = 7;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ASTER_LARGE_FIELD_NUMBER = 7;
    ...
    public static final int ASTER_LITTLE_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (asterLarge_ != null) {
        output.writeMessage(7, getAsterLarge());
      }
      if (asterLittle_ != null) {
        output.writeMessage(8, getAsterLittle());
      }
    ...
    public int getSerializedSize() {
      ...
      if (asterLarge_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, getAsterLarge());
      }
      if (asterLittle_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, getAsterLittle());
      }
      if (isContentClosed_ != false) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rProgressDetailInfo.proto\"\245\002\n\027AsterActiv" +
      "ityDetailInfo\022*\n\013aster_large\030\007 \001(\0132\025.Ast" +
      "erLargeDetailInfo\0220\n\016aster_progress\030\017 \001(" +
      "\0132\030.AsterProgressDetailInfo\022&\n\taster_mid" +
      "\030\005 \001(\0132\023.AsterMidDetailInfo\022,\n\014aster_lit" +
      "tle\030\010 \001(\0132\026.AsterLittleDetailInfo\022\032\n\022con" +
      "tent_close_time\030\006 \001(\r\022\037\n\027is_special_rewa" +
      "rd_taken\030\003 \001(\010\022\031\n\021is_content_closed\030\n \001(" +
    ...
    internal_static_AsterActivityDetailInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AsterActivityDetailInfo_descriptor,
        new java.lang.String[] { "AsterLarge", "AsterProgress", "AsterMid", "AsterLittle", "ContentCloseTime", "IsSpecialRewardTaken", "IsContentClosed", });
    emu.grasscutter.net.proto.AsterLargeDetailInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AsterLittleDetailInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AsterMidDetailInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AsterProgressDetailInfoOuterClass.getDescriptor();
