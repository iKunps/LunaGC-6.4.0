...
public final class EvtSetAttackTargetInfoOuterClass {
  ...
  public interface EvtSetAttackTargetInfoOrBuilder extends
    ...
    /**
     * <code>uint32 attack_target_id = 4;</code>
     * @return The attackTargetId.
     */
    int getAttackTargetId();

    /**
     * <code>uint32 select_point_index = 15;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ATTACK_TARGET_ID_FIELD_NUMBER = 4;
    ...
    public static final int SELECT_POINT_INDEX_FIELD_NUMBER = 15;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (attackTargetId_ != 0) {
        output.writeUInt32(4, attackTargetId_);
      }
      if (entityId_ != 0) {
        output.writeUInt32(5, entityId_);
      }
      if (selectPointIndex_ != 0) {
        output.writeUInt32(15, selectPointIndex_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (attackTargetId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, attackTargetId_);
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (selectPointIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, selectPointIndex_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ttack_target_id\030\004 \001(\r\022\032\n\022select_point_in" +
