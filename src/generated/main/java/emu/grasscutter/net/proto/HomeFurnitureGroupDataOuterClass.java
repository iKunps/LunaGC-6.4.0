...
public final class HomeFurnitureGroupDataOuterClass {
  ...
  public interface HomeFurnitureGroupDataOrBuilder extends
    ...
    /**
     * <code>repeated .HomeFurnitureData virtual_furniure_list = 6;</code>
     */
    ...
    /**
     * <code>uint32 group_furniture_index = 14;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int VIRTUAL_FURNIURE_LIST_FIELD_NUMBER = 6;
    ...
    public static final int GROUP_FURNITURE_INDEX_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < virtualFurniureList_.size(); i++) {
        output.writeMessage(6, virtualFurniureList_.get(i));
      }
      if (groupFurnitureIndex_ != 0) {
        output.writeUInt32(14, groupFurnitureIndex_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < virtualFurniureList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, virtualFurniureList_.get(i));
      }
      if (groupFurnitureIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, groupFurnitureIndex_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "a\0221\n\025virtual_furniure_list\030\006 \003(\0132\022.HomeF" +
      "urnitureData\022\035\n\025group_furniture_index\030\016 " +
