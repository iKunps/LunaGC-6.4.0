...
public final class TeamChainDetailInfoOuterClass {
  ...
  public interface TeamChainDetailInfoOrBuilder extends
    ...
    /**
     * <code>repeated .TeamChainStageData stage_data_list = 7;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < stageDataList_.size(); i++) {
        output.writeMessage(7, stageDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < stageDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, stageDataList_.get(i));
      }
      if (isTokenCostumeReward_ != false) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "stage_data_list\030\007 \003(\0132\023.TeamChainStageDa" +
