...
public final class PullRecentChatRspOuterClass {
  ...
  public interface PullRecentChatRspOrBuilder extends
    ...
    /**
     * <code>repeated .ChatInfo chat_info = 8;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CHAT_INFO_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < chatInfo_.size(); i++) {
        output.writeMessage(8, chatInfo_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < chatInfo_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, chatInfo_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
