...
public final class UpdatePlayerShowAvatarListReqOuterClass {
  ...
  public interface UpdatePlayerShowAvatarListReqOrBuilder extends
    ...
    /**
     * <code>bool is_show_constellation_num = 9;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_SHOW_CONSTELLATION_NUM_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isShowConstellationNum_ != false) {
        output.writeBool(9, isShowConstellationNum_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (isShowConstellationNum_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(9, isShowConstellationNum_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < showAvatarIdList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\001(\010\022!\n\031is_show_constellation_num\030\t \001(\010B\033" +
