...
public final class RoguelikeCardGachaNotifyOuterClass {
  ...
  public interface RoguelikeCardGachaNotifyOrBuilder extends
    ...
    /**
     * <code>bool is_can_refresh = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_CAN_REFRESH_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isCanRefresh_ != false) {
        output.writeBool(2, isCanRefresh_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (isCanRefresh_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(2, isCanRefresh_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < cardList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "elikeCardGachaNotify\022\021\n\tcard_list\030\006 \003(\r\022" +
      "\026\n\016is_can_refresh\030\002 \001(\010B\033\n\031emu.grasscutt" +
