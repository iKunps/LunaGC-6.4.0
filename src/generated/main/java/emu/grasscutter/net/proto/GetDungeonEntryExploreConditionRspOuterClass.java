...
public final class GetDungeonEntryExploreConditionRspOuterClass {
  ...
  public interface GetDungeonEntryExploreConditionRspOrBuilder extends
    ...
    /**
     * <code>.DungeonEntryCond dungeon_entry_cond = 9;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DUNGEON_ENTRY_COND_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (dungeonEntryCond_ != null) {
        output.writeMessage(9, getDungeonEntryCond());
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (dungeonEntryCond_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, getDungeonEntryCond());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "y_cond\030\t \001(\0132\021.DungeonEntryCond\022\017\n\007retco" +
