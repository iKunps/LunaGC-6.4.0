...
public final class EntityAuthorityChangeNotifyOuterClass {
  ...
  public interface EntityAuthorityChangeNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .AuthorityChange authority_change_list = 5;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AUTHORITY_CHANGE_LIST_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < authorityChangeList_.size(); i++) {
        output.writeMessage(5, authorityChangeList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < authorityChangeList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, authorityChangeList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ngeNotify\022/\n\025authority_change_list\030\005 \003(\013" +
