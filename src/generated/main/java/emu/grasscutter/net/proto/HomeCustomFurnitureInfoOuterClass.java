...
public final class HomeCustomFurnitureInfoOuterClass {
  ...
  public interface HomeCustomFurnitureInfoOrBuilder extends
    ...
    /**
     * <code>repeated .CustomCommonNodeInfo sub_furniture_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SUB_FURNITURE_LIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < subFurnitureList_.size(); i++) {
        output.writeMessage(2, subFurnitureList_.get(i));
      }
      if (guid_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < subFurnitureList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, subFurnitureList_.get(i));
      }
      if (guid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "reInfo\0221\n\022sub_furniture_list\030\002 \003(\0132\025.Cus" +
