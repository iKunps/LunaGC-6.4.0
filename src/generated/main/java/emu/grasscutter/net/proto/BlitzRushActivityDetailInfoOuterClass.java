...
public final class BlitzRushActivityDetailInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < parkourLevelInfoList_.size(); i++) {
        output.writeMessage(5, parkourLevelInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < parkourLevelInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, parkourLevelInfoList_.get(i));
      }
      for (int i = 0; i < stageList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ge_list\030\006 \003(\0132\017.BlitzRushStage\0222\n\027parkou" +
      "r_level_info_list\030\005 \003(\0132\021.ParkourLevelIn" +
      "fo\022\031\n\021is_content_closed\030\016 \001(\010\022\032\n\022content" +
      "_close_time\030\r \001(\rB\033\n\031emu.grasscutter.net" +
      ".protob\006proto3"
    };
