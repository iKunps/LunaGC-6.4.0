...
public final class ActivityUpdateWatcherNotifyOuterClass {
  ...
  public interface ActivityUpdateWatcherNotifyOrBuilder extends
    ...
    /**
     * <code>.ActivityWatcherInfo watcher_info = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int WATCHER_INFO_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (watcherInfo_ != null) {
        output.writeMessage(1, getWatcherInfo());
      }
      if (activityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (watcherInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, getWatcherInfo());
      }
      if (activityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "WatcherNotify\022*\n\014watcher_info\030\001 \001(\0132\024.Ac" +
