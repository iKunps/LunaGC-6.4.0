...
public final class GravenInnocenceDetailInfoOuterClass {
  ...
  public interface GravenInnocenceDetailInfoOrBuilder extends
    ...
    /**
     * <code>.GravenInnocenceCampInfo camp_info = 15;</code>
    ...
    /**
     * <code>.GravenInnocenceRaceInfo race_info = 7;</code>
    ...
    /**
     * <code>.GravenInnocenceCarveInfo carve_info = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CARVE_INFO_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (carveInfo_ != null) {
        output.writeMessage(1, getCarveInfo());
      }
      if (raceInfo_ != null) {
        output.writeMessage(7, getRaceInfo());
      }
      if (isContentClosed_ != false) {
        output.writeBool(9, isContentClosed_);
      }
      if (photoInfo_ != null) {
        output.writeMessage(14, getPhotoInfo());
      }
      if (campInfo_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (carveInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, getCarveInfo());
      }
      if (raceInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, getRaceInfo());
      }
      if (isContentClosed_ != false) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (photoInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, getPhotoInfo());
      }
      if (campInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fo\030\017 \001(\0132\030.GravenInnocenceCampInfo\022-\n\nph" +
      "oto_info\030\016 \001(\0132\031.GravenInnocencePhotoInf" +
      "o\022+\n\trace_info\030\007 \001(\0132\030.GravenInnocenceRa" +
      "ceInfo\022-\n\ncarve_info\030\001 \001(\0132\031.GravenInnoc" +
      "enceCarveInfo\022\031\n\021is_content_closed\030\t \001(\010" +
    ...
    internal_static_GravenInnocenceDetailInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GravenInnocenceDetailInfo_descriptor,
        new java.lang.String[] { "CampInfo", "PhotoInfo", "RaceInfo", "CarveInfo", "IsContentClosed", });
    emu.grasscutter.net.proto.GravenInnocenceCampInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GravenInnocenceCarveInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GravenInnocencePhotoInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GravenInnocenceRaceInfoOuterClass.getDescriptor();
