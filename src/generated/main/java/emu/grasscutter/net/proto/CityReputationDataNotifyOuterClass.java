...
public final class CityReputationDataNotifyOuterClass {
  ...
  public interface CityReputationDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .CityReputationSimpleInfo simple_info_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < simpleInfoList_.size(); i++) {
        output.writeMessage(2, simpleInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < simpleInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, simpleInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "onDataNotify\0223\n\020simple_info_list\030\002 \003(\0132\031" +
