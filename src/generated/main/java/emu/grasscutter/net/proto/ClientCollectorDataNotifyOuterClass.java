...
public final class ClientCollectorDataNotifyOuterClass {
  ...
  public interface ClientCollectorDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .ClientCollectorData client_collector_data_list = 5;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CLIENT_COLLECTOR_DATA_LIST_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < clientCollectorDataList_.size(); i++) {
        output.writeMessage(5, clientCollectorDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < clientCollectorDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, clientCollectorDataList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\005 \003(\0132\024.ClientCollectorDataB\033\n\031emu.grass" +
