...
public final class SceneGallerySummerTimeV2BoatInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (param3_ != 0) {
        output.writeUInt32(4, param3_);
      }
      if (param2_ != 0) {
        output.writeUInt32(7, param2_);
      }
      if (param1_ != 0) {
        output.writeUInt32(11, param1_);
      }
      if (usedTime_ != 0) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "param3\030\004 \001(\r\022\021\n\tused_time\030\016 \001(\r\022\016\n\006param" +
      "1\030\013 \001(\r\022\016\n\006param2\030\007 \001(\rB\033\n\031emu.grasscutt" +
