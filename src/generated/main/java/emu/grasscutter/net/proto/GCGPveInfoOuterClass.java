...
public final class GCGPveInfoOuterClass {
  ...
  public interface GCGPveInfoOrBuilder extends
    ...
    /**
     * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
     */
    java.util.List<emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData> 
        getLevelDataListList();
    /**
     * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
     */
    emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData getLevelDataList(int index);
    /**
     * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
     */
     ...
     * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
     */
    java.util.List<? extends emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelDataOrBuilder> 
        getLevelDataListOrBuilderList();
    /**
     * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
     */
    emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelDataOrBuilder getLevelDataListOrBuilder(
        int index);

    /**
     * <code>bool AKBGHHBLHBE = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 122: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                levelDataList_ = new java.util.ArrayList<emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData>();
                mutable_bitField0_ |= 0x00000001;
              }
              levelDataList_.add(
                  input.readMessage(emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.parser(), extensionRegistry));
              break;
            }
            default: {
    ...
    public static final int LEVEL_DATA_LIST_FIELD_NUMBER = 15;
    private java.util.List<emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData> levelDataList_;
    /**
     * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData> getLevelDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelDataOrBuilder> 
        getLevelDataListOrBuilderList() {
      return levelDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData getLevelDataList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelDataOrBuilder getLevelDataListOrBuilder(
        int index) {
      return levelDataList_.get(index);
    }

    public static final int AKBGHHBLHBE_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (aKBGHHBLHBE_ != false) {
        output.writeBool(4, aKBGHHBLHBE_);
      }
      for (int i = 0; i < levelDataList_.size(); i++) {
        output.writeMessage(15, levelDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      if (aKBGHHBLHBE_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(4, aKBGHHBLHBE_);
      }
      for (int i = 0; i < levelDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(15, levelDataList_.get(i));
      }
    ...
    public static final class Builder extends
      ...
      private void ensureLevelDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          levelDataList_ = new java.util.ArrayList<emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData>(levelDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData, emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.Builder, emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelDataOrBuilder> levelDataListBuilder_;
      ...
      public Builder setLevelDataList(
          int index, emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData value) {
        if (levelDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setLevelDataList(
          int index, emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.Builder builderForValue) {
        if (levelDataListBuilder_ == null) {
          ensureLevelDataListIsMutable();
       ...
       * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
       */
      public Builder addLevelDataList(emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData value) {
        if (levelDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addLevelDataList(
          emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.Builder builderForValue) {
        if (levelDataListBuilder_ == null) {
          ensureLevelDataListIsMutable();
      ...
      public Builder addAllLevelDataList(
          java.lang.Iterable<? extends emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData> values) {
        if (levelDataListBuilder_ == null) {
          ensureLevelDataListIsMutable();
       ...
       * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
       */
      public emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.Builder getLevelDataListBuilder(
          int index) {
       ...
       * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
       */
      public emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.Builder addLevelDataListBuilder() {
        return getLevelDataListFieldBuilder().addBuilder(
            emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
       */
      public emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.Builder addLevelDataListBuilder(
          int index) {
        return getLevelDataListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGPveLevelData level_data_list = 15;</code>
       */
      public java.util.List<emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.Builder> 
           getLevelDataListBuilderList() {
        return getLevelDataListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData, emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelData.Builder, emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.GCGPveLevelDataOrBuilder> 
          getLevelDataListFieldBuilder() {
        if (levelDataListBuilder_ == null) {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\020GCGPveInfo.proto\032\025GCGPveLevelData.prot" +
      "o\"L\n\nGCGPveInfo\022)\n\017level_data_list\030\017 \003(\013" +
      "2\020.GCGPveLevelData\022\023\n\013AKBGHHBLHBE\030\004 \001(\010B" +
      "\033\n\031emu.grasscutter.net.protob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.getDescriptor(),
        });
    internal_static_GCGPveInfo_descriptor =
    ...
    internal_static_GCGPveInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGPveInfo_descriptor,
        new java.lang.String[] { "LevelDataList", "AKBGHHBLHBE", });
    emu.grasscutter.net.proto.GCGPveLevelDataOuterClass.getDescriptor();
  }
