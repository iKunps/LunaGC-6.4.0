...
public final class GCGPvePuzzleInfoOuterClass {
  ...
  public interface GCGPvePuzzleInfoOrBuilder extends
    ...
    /**
     * <code>repeated uint32 NMFJFLEHDKI = 1;</code>
     * @return A list containing the nMFJFLEHDKI.
     */
    java.util.List<java.lang.Integer> getNMFJFLEHDKIList();
    /**
     * <code>repeated uint32 NMFJFLEHDKI = 1;</code>
     * @return The count of nMFJFLEHDKI.
     */
    int getNMFJFLEHDKICount();
    /**
     * <code>repeated uint32 NMFJFLEHDKI = 1;</code>
     * @param index The index of the element to return.
     * @return The nMFJFLEHDKI at the given index.
     */
    int getNMFJFLEHDKI(int index);

    /**
     * <code>bool AKBGHHBLHBE = 12;</code>
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 8: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                nMFJFLEHDKI_ = newIntList();
                mutable_bitField0_ |= 0x00000001;
              }
              nMFJFLEHDKI_.addInt(input.readUInt32());
              break;
            }
            case 10: {
    ...
    public static final int NMFJFLEHDKI_FIELD_NUMBER = 1;
    private com.google.protobuf.Internal.IntList nMFJFLEHDKI_;
    /**
     * <code>repeated uint32 NMFJFLEHDKI = 1;</code>
     * @return A list containing the nMFJFLEHDKI.
     */
     ...
     * @return The count of nMFJFLEHDKI.
     */
    public int getNMFJFLEHDKICount() {
      return nMFJFLEHDKI_.size();
    }
    /**
     * <code>repeated uint32 NMFJFLEHDKI = 1;</code>
     * @param index The index of the element to return.
     * @return The nMFJFLEHDKI at the given index.
     */
    public int getNMFJFLEHDKI(int index) {
      return nMFJFLEHDKI_.getInt(index);
    }
    private int nMFJFLEHDKIMemoizedSerializedSize = -1;

    public static final int AKBGHHBLHBE_FIELD_NUMBER = 12;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (getNMFJFLEHDKIList().size() > 0) {
        output.writeUInt32NoTag(10);
        output.writeUInt32NoTag(nMFJFLEHDKIMemoizedSerializedSize);
      }
      for (int i = 0; i < nMFJFLEHDKI_.size(); i++) {
        output.writeUInt32NoTag(nMFJFLEHDKI_.getInt(i));
      }
      if (aKBGHHBLHBE_ != false) {
        output.writeBool(12, aKBGHHBLHBE_);
      }
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < nMFJFLEHDKI_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(nMFJFLEHDKI_.getInt(i));
        }
        size += dataSize;
        if (!getNMFJFLEHDKIList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        nMFJFLEHDKIMemoizedSerializedSize = dataSize;
      }
      if (aKBGHHBLHBE_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(12, aKBGHHBLHBE_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getNMFJFLEHDKIList()
          .equals(other.getNMFJFLEHDKIList())) return false;
      if (getAKBGHHBLHBE()
    ...
    public int hashCode() {
      ...
      if (getNMFJFLEHDKICount() > 0) {
        hash = (37 * hash) + NMFJFLEHDKI_FIELD_NUMBER;
        hash = (53 * hash) + getNMFJFLEHDKIList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.GCGPvePuzzleInfoOuterClass.GCGPvePuzzleInfo buildPartial() {
        ...
        if (((bitField0_ & 0x00000001) != 0)) {
          nMFJFLEHDKI_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000001);
        }
        result.nMFJFLEHDKI_ = nMFJFLEHDKI_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GCGPvePuzzleInfoOuterClass.GCGPvePuzzleInfo other) {
        ...
        if (!other.nMFJFLEHDKI_.isEmpty()) {
          if (nMFJFLEHDKI_.isEmpty()) {
            nMFJFLEHDKI_ = other.nMFJFLEHDKI_;
            bitField0_ = (bitField0_ & ~0x00000001);
          } else {
            ensureNMFJFLEHDKIIsMutable();
            nMFJFLEHDKI_.addAll(other.nMFJFLEHDKI_);
          }
          onChanged();
        }
      ...
      private com.google.protobuf.Internal.IntList nMFJFLEHDKI_ = emptyIntList();
      private void ensureNMFJFLEHDKIIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          nMFJFLEHDKI_ = mutableCopy(nMFJFLEHDKI_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000001) != 0) ?
                 java.util.Collections.unmodifiableList(nMFJFLEHDKI_) : nMFJFLEHDKI_;
      }
      /**
       * <code>repeated uint32 NMFJFLEHDKI = 1;</code>
       * @return The count of nMFJFLEHDKI.
       ...
       * @param value The nMFJFLEHDKI to set.
       * @return This builder for chaining.
       */
      public Builder setNMFJFLEHDKI(
          int index, int value) {
        ensureNMFJFLEHDKIIsMutable();
        nMFJFLEHDKI_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 NMFJFLEHDKI = 1;</code>
       * @param value The nMFJFLEHDKI to add.
       * @return This builder for chaining.
       */
      public Builder addNMFJFLEHDKI(int value) {
        ensureNMFJFLEHDKIIsMutable();
        nMFJFLEHDKI_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 NMFJFLEHDKI = 1;</code>
       * @param values The nMFJFLEHDKI to add.
       * @return This builder for chaining.
       */
      public Builder addAllNMFJFLEHDKI(
       ...
       * @return This builder for chaining.
       */
      public Builder clearNMFJFLEHDKI() {
        nMFJFLEHDKI_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000001);
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Info\022\023\n\013NMFJFLEHDKI\030\001 \003(\r\022\023\n\013AKBGHHBLHBE" +
    ...
    internal_static_GCGPvePuzzleInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGPvePuzzleInfo_descriptor,
        new java.lang.String[] { "NMFJFLEHDKI", "AKBGHHBLHBE", });
  }
