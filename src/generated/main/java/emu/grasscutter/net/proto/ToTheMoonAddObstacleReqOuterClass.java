...
public final class ToTheMoonAddObstacleReqOuterClass {
  ...
  public interface ToTheMoonAddObstacleReqOrBuilder extends
    ...
    /**
     * <code>.ToTheMoonObstacleInfo obstacle = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int OBSTACLE_FIELD_NUMBER = 4;
    ...
    public static final int USE_EDGE_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (useEdge_ != false) {
        output.writeBool(3, useEdge_);
      }
      if (obstacle_ != null) {
        output.writeMessage(4, getObstacle());
      }
      if (sceneId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (useEdge_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(3, useEdge_);
      }
      if (obstacle_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, getObstacle());
      }
      if (sceneId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "acleReq\022(\n\010obstacle\030\004 \001(\0132\026.ToTheMoonObs" +
      "tacleInfo\022\020\n\010use_edge\030\003 \001(\010\022\020\n\010scene_id\030" +
      "\n \001(\r\022\020\n\010query_id\030\001 \001(\005B\033\n\031emu.grasscutt" +
