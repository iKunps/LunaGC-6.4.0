...
public final class LanternRiteActivityDetailInfoOuterClass {
  ...
  public interface LanternRiteActivityDetailInfoOrBuilder extends
    ...
    /**
     * <code>repeated .SalvageStageInfo stage_info_list = 6;</code>
     */
    ...
    /**
     * <code>.LanternRiteFireworksInfo fireworks_info = 9;</code>
    ...
    /**
     * <code>.LanternProjectionInfo projection_info = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int FIREWORKS_INFO_FIELD_NUMBER = 9;
    ...
    public static final int PROJECTION_INFO_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (projectionInfo_ != null) {
        output.writeMessage(5, getProjectionInfo());
      }
      for (int i = 0; i < stageInfoList_.size(); i++) {
        output.writeMessage(6, stageInfoList_.get(i));
      }
      if (fireworksInfo_ != null) {
        output.writeMessage(9, getFireworksInfo());
      }
    ...
    public int getSerializedSize() {
      ...
      if (projectionInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, getProjectionInfo());
      }
      for (int i = 0; i < stageInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (fireworksInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, getFireworksInfo());
      }
      if (isContentClosed_ != false) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "stage_info_list\030\006 \003(\0132\021.SalvageStageInfo" +
      "\0221\n\016fireworks_info\030\t \001(\0132\031.LanternRiteFi" +
      "reworksInfo\022/\n\017projection_info\030\005 \001(\0132\026.L" +
      "anternProjectionInfo\022\031\n\021is_content_close" +
    ...
    internal_static_LanternRiteActivityDetailInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_LanternRiteActivityDetailInfo_descriptor,
        new java.lang.String[] { "StageInfoList", "FireworksInfo", "ProjectionInfo", "IsContentClosed", });
    emu.grasscutter.net.proto.LanternProjectionInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.LanternRiteFireworksInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.SalvageStageInfoOuterClass.getDescriptor();
  }
