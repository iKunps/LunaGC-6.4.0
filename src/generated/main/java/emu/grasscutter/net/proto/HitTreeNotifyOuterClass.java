...
public final class HitTreeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DROP_POS_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (dropPos_ != null) {
        output.writeMessage(3, getDropPos());
      }
      if (treePos_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (dropPos_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getDropPos());
      }
      if (treePos_ != null) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "itTreeNotify\022\031\n\010drop_pos\030\003 \001(\0132\007.Vector\022" +
      "\031\n\010tree_pos\030\006 \001(\0132\007.Vector\022\021\n\ttree_type\030" +
