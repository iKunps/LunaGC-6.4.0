...
public final class GetSceneAreaRspOuterClass {
  ...
  public interface GetSceneAreaRspOrBuilder extends
    ...
    /**
     * <code>repeated .CityInfo city_info_list = 10;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CITY_INFO_LIST_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < cityInfoList_.size(); i++) {
        output.writeMessage(10, cityInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < cityInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, cityInfoList_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < areaIdList_.size(); i++) {
