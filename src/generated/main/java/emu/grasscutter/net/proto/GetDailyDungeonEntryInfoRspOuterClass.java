...
public final class GetDailyDungeonEntryInfoRspOuterClass {
  ...
  public interface GetDailyDungeonEntryInfoRspOrBuilder extends
    ...
    /**
     * <code>repeated .DailyDungeonEntryInfo daily_dungeon_info_list = 3;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DAILY_DUNGEON_INFO_LIST_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < dailyDungeonInfoList_.size(); i++) {
        output.writeMessage(3, dailyDungeonInfoList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < dailyDungeonInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, dailyDungeonInfoList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "st\030\003 \003(\0132\026.DailyDungeonEntryInfo\022\017\n\007retc" +
