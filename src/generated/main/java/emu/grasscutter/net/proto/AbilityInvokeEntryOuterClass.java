...
public final class AbilityInvokeEntryOuterClass {
  ...
  public interface AbilityInvokeEntryOrBuilder extends
    ...
    /**
     * <code>.AbilityInvokeEntryHead head = 14;</code>
    ...
    /**
     * <code>bytes ability_data = 12;</code>
    ...
    /**
     * <code>double total_tick_time = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int TOTAL_TICK_TIME_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (totalTickTime_ != 0D) {
        output.writeDouble(2, totalTickTime_);
      }
      if (eventId_ != 0) {
      ...
      if (argumentType_ != emu.grasscutter.net.proto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument.AbilityInvokeArgument_ABILITY_NONE.getNumber()) {
        output.writeEnum(10, argumentType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (totalTickTime_ != 0D) {
        size += com.google.protobuf.CodedOutputStream
          .computeDoubleSize(2, totalTickTime_);
      }
      if (eventId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (argumentType_ != emu.grasscutter.net.proto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument.AbilityInvokeArgument_ABILITY_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(10, argumentType_);
      }
      if (!abilityData_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\0132\027.AbilityInvokeEntryHead\022\024\n\014ability_d" +
      "ata\030\014 \001(\014\022\024\n\014forward_peer\030\007 \001(\r\022-\n\rargum" +
      "ent_type\030\n \001(\0162\026.AbilityInvokeArgument\022\021" +
      "\n\tentity_id\030\017 \001(\r\022\020\n\010event_id\030\003 \001(\r\022\027\n\017t" +
      "otal_tick_time\030\002 \001(\001\022\026\n\016is_ignore_auth\030\006" +
    ...
    internal_static_AbilityInvokeEntry_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityInvokeEntry_descriptor,
        new java.lang.String[] { "Head", "AbilityData", "ForwardPeer", "ArgumentType", "EntityId", "EventId", "TotalTickTime", "IsIgnoreAuth", });
    emu.grasscutter.net.proto.AbilityInvokeArgumentOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AbilityInvokeEntryHeadOuterClass.getDescriptor();
  }
