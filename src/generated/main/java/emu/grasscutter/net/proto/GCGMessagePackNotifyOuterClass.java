...
public final class GCGMessagePackNotifyOuterClass {
  ...
  public interface GCGMessagePackNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .GCGMessagePack msg_pack_list = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MSG_PACK_LIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < msgPackList_.size(); i++) {
        output.writeMessage(6, msgPackList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < msgPackList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, msgPackList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "g_pack_list\030\006 \003(\0132\017.GCGMessagePack\022\022\n\nse" +
      "rver_seq\030\001 \001(\rB\033\n\031emu.grasscutter.net.pr" +
      "otob\006proto3"
    };
