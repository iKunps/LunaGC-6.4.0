...
public final class SignInInfoRspOuterClass {
  ...
  public interface SignInInfoRspOrBuilder extends
    ...
    /**
     * <code>repeated .SignInInfo sign_in_info_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SIGN_IN_INFO_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < signInInfoList_.size(); i++) {
        output.writeMessage(4, signInInfoList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < signInInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, signInInfoList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
