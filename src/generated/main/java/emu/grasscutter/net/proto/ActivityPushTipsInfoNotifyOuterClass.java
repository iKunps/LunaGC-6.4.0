...
public final class ActivityPushTipsInfoNotifyOuterClass {
  ...
  public interface ActivityPushTipsInfoNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .ActivityPushTipsData activity_push_tips_data_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ACTIVITY_PUSH_TIPS_DATA_LIST_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < activityPushTipsDataList_.size(); i++) {
        output.writeMessage(1, activityPushTipsDataList_.get(i));
      }
      if (activityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < activityPushTipsDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, activityPushTipsDataList_.get(i));
      }
      if (activityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_list\030\001 \003(\0132\025.ActivityPushTipsData\022\023\n\013ac" +
      "tivity_id\030\004 \001(\r\022\023\n\013schedule_id\030\014 \001(\rB\033\n\031" +
