...
public final class PlayerOfferingDataNotifyOuterClass {
  ...
  public interface PlayerOfferingDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .PlayerOfferingData offering_data_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int OFFERING_DATA_LIST_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < offeringDataList_.size(); i++) {
        output.writeMessage(1, offeringDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < offeringDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, offeringDataList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Notify\022/\n\022offering_data_list\030\001 \003(\0132\023.Pla" +
