...
public final class DungeonChallengeFinishNotifyOuterClass {
  ...
  public interface DungeonChallengeFinishNotifyOrBuilder extends
    ...
    /**
     * <code>.ChallengeFinishType finish_type = 14;</code>
    ...
    /**
     * <code>.PotionDungeonResultInfo potion_dungeon_result_info = 32;</code>
    ...
    /**
     * <code>.CustomDungeonResultInfo custom_dungeon_result_info = 169;</code>
    ...
    /**
     * <code>.EffigyChallengeDungeonResultInfo effigy_challenge_dungeon_result_info = 1029;</code>
    ...
    /**
     * <code>.ChannellerSlabLoopDungeonResultInfo channeller_slab_loop_dungeon_result_info = 1604;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum DetailCase
      ...
      POTION_DUNGEON_RESULT_INFO(32),
      CUSTOM_DUNGEON_RESULT_INFO(169),
      EFFIGY_CHALLENGE_DUNGEON_RESULT_INFO(1029),
      CHANNELLER_SLAB_LOOP_DUNGEON_RESULT_INFO(1604),
      DETAIL_NOT_SET(0);
      ...
      public static DetailCase forNumber(int value) {
        switch (value) {
          case 32: return POTION_DUNGEON_RESULT_INFO;
          case 169: return CUSTOM_DUNGEON_RESULT_INFO;
          case 1029: return EFFIGY_CHALLENGE_DUNGEON_RESULT_INFO;
          case 1604: return CHANNELLER_SLAB_LOOP_DUNGEON_RESULT_INFO;
    ...
    public static final int POTION_DUNGEON_RESULT_INFO_FIELD_NUMBER = 32;
    /**
     * <code>.PotionDungeonResultInfo potion_dungeon_result_info = 32;</code>
     * @return Whether the potionDungeonResultInfo field is set.
     */
    ...
    public static final int CUSTOM_DUNGEON_RESULT_INFO_FIELD_NUMBER = 169;
    /**
     * <code>.CustomDungeonResultInfo custom_dungeon_result_info = 169;</code>
     * @return Whether the customDungeonResultInfo field is set.
     */
    ...
    public static final int EFFIGY_CHALLENGE_DUNGEON_RESULT_INFO_FIELD_NUMBER = 1029;
    /**
     * <code>.EffigyChallengeDungeonResultInfo effigy_challenge_dungeon_result_info = 1029;</code>
     * @return Whether the effigyChallengeDungeonResultInfo field is set.
     */
    ...
    public static final int CHANNELLER_SLAB_LOOP_DUNGEON_RESULT_INFO_FIELD_NUMBER = 1604;
    /**
     * <code>.ChannellerSlabLoopDungeonResultInfo channeller_slab_loop_dungeon_result_info = 1604;</code>
     * @return Whether the channellerSlabLoopDungeonResultInfo field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (challengeRecordType_ != 0) {
        output.writeUInt32(15, challengeRecordType_);
      }
      if (detailCase_ == 32) {
        output.writeMessage(32, (emu.grasscutter.net.proto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo) detail_);
      }
      if (detailCase_ == 169) {
        output.writeMessage(169, (emu.grasscutter.net.proto.CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1029) {
        output.writeMessage(1029, (emu.grasscutter.net.proto.EffigyChallengeDungeonResultInfoOuterClass.EffigyChallengeDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1604) {
        output.writeMessage(1604, (emu.grasscutter.net.proto.ChannellerSlabLoopDungeonResultInfoOuterClass.ChannellerSlabLoopDungeonResultInfo) detail_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (challengeRecordType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, challengeRecordType_);
      }
      if (detailCase_ == 32) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(32, (emu.grasscutter.net.proto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo) detail_);
      }
      if (detailCase_ == 169) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(169, (emu.grasscutter.net.proto.CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1029) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1029, (emu.grasscutter.net.proto.EffigyChallengeDungeonResultInfoOuterClass.EffigyChallengeDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1604) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1604, (emu.grasscutter.net.proto.ChannellerSlabLoopDungeonResultInfoOuterClass.ChannellerSlabLoopDungeonResultInfo) detail_);
      }
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfoOrBuilder getPotionDungeonResultInfoOrBuilder() {
        if ((detailCase_ == 32) && (potionDungeonResultInfoBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.CustomDungeonResultInfoOuterClass.CustomDungeonResultInfoOrBuilder getCustomDungeonResultInfoOrBuilder() {
        if ((detailCase_ == 169) && (customDungeonResultInfoBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.EffigyChallengeDungeonResultInfoOuterClass.EffigyChallengeDungeonResultInfoOrBuilder getEffigyChallengeDungeonResultInfoOrBuilder() {
        if ((detailCase_ == 1029) && (effigyChallengeDungeonResultInfoBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.ChannellerSlabLoopDungeonResultInfoOuterClass.ChannellerSlabLoopDungeonResultInfoOrBuilder getChannellerSlabLoopDungeonResultInfoOrBuilder() {
        if ((detailCase_ == 1604) && (channellerSlabLoopDungeonResultInfoBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fo.proto\032\031StrengthenPointData.proto\"\303\005\n\034" +
      "DungeonChallengeFinishNotify\022\\\n\031strength" +
      "en_point_data_map\030\006 \003(\01329.DungeonChallen" +
      "geFinishNotify.StrengthenPointDataMapEnt" +
      "ry\022\022\n\nis_success\030\n \001(\010\022\025\n\ris_new_record\030" +
      "\013 \001(\010\022\035\n\025challenge_record_type\030\017 \001(\r\022\021\n\t" +
      "time_cost\030\002 \001(\r\022)\n\013finish_type\030\016 \001(\0162\024.C" +
      "hallengeFinishType\022\027\n\017challenge_index\030\004 " +
      "\001(\r\022\025\n\rcurrent_value\030\005 \001(\r\022>\n\032potion_dun" +
      "geon_result_info\030  \001(\0132\030.PotionDungeonRe" +
      "sultInfoH\000\022?\n\032custom_dungeon_result_info" +
      "\030\251\001 \001(\0132\030.CustomDungeonResultInfoH\000\022R\n$e" +
      "ffigy_challenge_dungeon_result_info\030\205\010 \001" +
      "(\0132!.EffigyChallengeDungeonResultInfoH\000\022" +
      "Y\n(channeller_slab_loop_dungeon_result_i" +
      "nfo\030\304\014 \001(\0132$.ChannellerSlabLoopDungeonRe" +
    ...
    internal_static_DungeonChallengeFinishNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_DungeonChallengeFinishNotify_descriptor,
        new java.lang.String[] { "StrengthenPointDataMap", "IsSuccess", "IsNewRecord", "ChallengeRecordType", "TimeCost", "FinishType", "ChallengeIndex", "CurrentValue", "PotionDungeonResultInfo", "CustomDungeonResultInfo", "EffigyChallengeDungeonResultInfo", "ChannellerSlabLoopDungeonResultInfo", "Detail", });
    internal_static_DungeonChallengeFinishNotify_StrengthenPointDataMapEntry_descriptor =
