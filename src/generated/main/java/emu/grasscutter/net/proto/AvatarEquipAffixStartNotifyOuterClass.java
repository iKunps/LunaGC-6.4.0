...
public final class AvatarEquipAffixStartNotifyOuterClass {
  ...
  public interface AvatarEquipAffixStartNotifyOrBuilder extends
    ...
    /**
     * <code>.AvatarEquipAffixInfo equip_affix_info = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int EQUIP_AFFIX_INFO_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (equipAffixInfo_ != null) {
        output.writeMessage(4, getEquipAffixInfo());
      }
      if (avatarGuid_ != 0L) {
    ...
    public int getSerializedSize() {
      ...
      if (equipAffixInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, getEquipAffixInfo());
      }
      if (avatarGuid_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fixStartNotify\022/\n\020equip_affix_info\030\004 \001(\013" +
