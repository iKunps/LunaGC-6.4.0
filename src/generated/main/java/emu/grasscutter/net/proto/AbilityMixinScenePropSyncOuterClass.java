...
public final class AbilityMixinScenePropSyncOuterClass {
  ...
  public interface AbilityMixinScenePropSyncOrBuilder extends
    ...
    /**
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 3;</code>
     */
    ...
    /**
     * <code>repeated int64 delete_id_list = 6;</code>
    ...
    /**
     * <code>bool is_clear_all = 14;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MASSIVE_PROP_LIST_FIELD_NUMBER = 3;
    ...
    public static final int DELETE_ID_LIST_FIELD_NUMBER = 6;
    ...
    public static final int IS_CLEAR_ALL_FIELD_NUMBER = 14;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < massivePropList_.size(); i++) {
        output.writeMessage(3, massivePropList_.get(i));
      }
      ...
      if (isClearAll_ != false) {
        output.writeBool(14, isClearAll_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < massivePropList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, massivePropList_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < deleteIdList_.size(); i++) {
      ...
      if (isClearAll_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(14, isClearAll_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ePropSync\022/\n\021massive_prop_list\030\003 \003(\0132\024.M" +
      "assivePropSyncInfo\022\026\n\016delete_id_list\030\006 \003" +
      "(\003\022\024\n\014is_clear_all\030\016 \001(\010B\033\n\031emu.grasscut" +
