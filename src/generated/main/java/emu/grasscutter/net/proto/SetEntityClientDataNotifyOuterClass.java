...
public final class SetEntityClientDataNotifyOuterClass {
  ...
  public interface SetEntityClientDataNotifyOrBuilder extends
    ...
    /**
     * <code>.EntityClientData entity_client_data = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ENTITY_CLIENT_DATA_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (entityClientData_ != null) {
        output.writeMessage(3, getEntityClientData());
      }
      if (entityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (entityClientData_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getEntityClientData());
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Notify\022-\n\022entity_client_data\030\003 \001(\0132\021.Ent" +
