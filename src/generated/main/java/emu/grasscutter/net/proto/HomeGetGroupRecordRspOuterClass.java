...
public final class HomeGetGroupRecordRspOuterClass {
  ...
  public interface HomeGetGroupRecordRspOrBuilder extends
    ...
    /**
     * <code>.HomeGroupRecord group_record = 3;</code>
    ...
    /**
     * <code>uint32 record_type = 8;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int GROUP_RECORD_FIELD_NUMBER = 3;
    ...
    public static final int RECORD_TYPE_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (groupRecord_ != null) {
        output.writeMessage(3, getGroupRecord());
      }
      if (retcode_ != 0) {
        output.writeInt32(7, retcode_);
      }
      if (recordType_ != 0) {
        output.writeUInt32(8, recordType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (groupRecord_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getGroupRecord());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (recordType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, recordType_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\014group_record\030\003 \001(\0132\020.HomeGroupRecord\022\017\n" +
      "\007retcode\030\007 \001(\005\022\023\n\013record_type\030\010 \001(\rB\033\n\031e" +
