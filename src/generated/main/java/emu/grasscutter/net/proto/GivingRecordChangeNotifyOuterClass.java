...
public final class GivingRecordChangeNotifyOuterClass {
  ...
  public interface GivingRecordChangeNotifyOrBuilder extends
    ...
    /**
     * <code>.GivingRecord giving_record = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int GIVING_RECORD_FIELD_NUMBER = 1;
    ...
    public static final int IS_DEACTIVE_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (givingRecord_ != null) {
        output.writeMessage(1, getGivingRecord());
      }
      if (isDeactive_ != false) {
        output.writeBool(3, isDeactive_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (givingRecord_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, getGivingRecord());
      }
      if (isDeactive_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(3, isDeactive_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022$\n\rgiving_record\030\001 \001(\0132\r.GivingRecord\022\023" +
      "\n\013is_deactive\030\003 \001(\010B\033\n\031emu.grasscutter.n" +
      "et.protob\006proto3"
    };
