...
public final class GetAllActivatedBargainDataRspOuterClass {
  ...
  public interface GetAllActivatedBargainDataRspOrBuilder extends
    ...
    /**
     * <code>repeated .BargainSnapshot snapshot_list = 11;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SNAPSHOT_LIST_FIELD_NUMBER = 11;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < snapshotList_.size(); i++) {
        output.writeMessage(11, snapshotList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < snapshotList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(11, snapshotList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "argainDataRsp\022\'\n\rsnapshot_list\030\013 \003(\0132\020.B" +
