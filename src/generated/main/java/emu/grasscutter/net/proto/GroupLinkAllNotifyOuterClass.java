...
public final class GroupLinkAllNotifyOuterClass {
  ...
  public interface GroupLinkAllNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .GroupLinkBundle bundle_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BUNDLE_LIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < bundleList_.size(); i++) {
        output.writeMessage(2, bundleList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < bundleList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, bundleList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e_list\030\002 \003(\0132\020.GroupLinkBundleB\033\n\031emu.gr" +
