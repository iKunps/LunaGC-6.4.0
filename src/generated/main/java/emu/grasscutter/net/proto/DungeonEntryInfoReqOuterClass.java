...
public final class DungeonEntryInfoReqOuterClass {
  ...
  public interface DungeonEntryInfoReqOrBuilder extends
    ...
    /**
     * <code>repeated .Uint32Pair scene_point_id_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SCENE_POINT_ID_LIST_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < scenePointIdList_.size(); i++) {
        output.writeMessage(1, scenePointIdList_.get(i));
      }
      if (pointId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < scenePointIdList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, scenePointIdList_.get(i));
      }
      if (pointId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "int_id_list\030\001 \003(\0132\013.Uint32Pair\022\020\n\010point_" +
