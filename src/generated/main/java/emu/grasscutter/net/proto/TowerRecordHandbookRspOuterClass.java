...
public final class TowerRecordHandbookRspOuterClass {
  ...
  public interface TowerRecordHandbookRspOrBuilder extends
    ...
    /**
     * <code>repeated .TowerMonthlyDetail monthly_detail_list = 7;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MONTHLY_DETAIL_LIST_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < monthlyDetailList_.size(); i++) {
        output.writeMessage(7, monthlyDetailList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < monthlyDetailList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, monthlyDetailList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "sp\0220\n\023monthly_detail_list\030\007 \003(\0132\023.TowerM" +
