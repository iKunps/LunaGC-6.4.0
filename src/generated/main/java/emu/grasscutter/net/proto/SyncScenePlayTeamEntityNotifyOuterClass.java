...
public final class SyncScenePlayTeamEntityNotifyOuterClass {
  ...
  public interface SyncScenePlayTeamEntityNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .PlayTeamEntityInfo entity_info_list = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ENTITY_INFO_LIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < entityInfoList_.size(); i++) {
        output.writeMessage(6, entityInfoList_.get(i));
      }
      if (sceneId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < entityInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, entityInfoList_.get(i));
      }
      if (sceneId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "TeamEntityNotify\022-\n\020entity_info_list\030\006 \003" +
