...
public final class AbilityActionSetCrashDamageOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int HIT_POS_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (hitPos_ != null) {
        output.writeMessage(5, getHitPos());
      }
      if (damage_ != 0F) {
    ...
    public int getSerializedSize() {
      ...
      if (hitPos_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, getHitPos());
      }
      if (damage_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\030\n\007hit_pos\030\005 \001(\0132\007.Vector\022\016\n\006damage\030\014 \001" +
