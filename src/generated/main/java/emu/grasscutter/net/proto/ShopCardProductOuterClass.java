...
public final class ShopCardProductOuterClass {
  ...
  public interface ShopCardProductOrBuilder extends
    ...
    public emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.JFIFNKLCBLECase getJFIFNKLCBLECase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 810: {
              ...
              if (jFIFNKLCBLECase_ == 101) {
                subBuilder = ((emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard) jFIFNKLCBLE_).toBuilder();
              }
              jFIFNKLCBLE_ =
                  input.readMessage(emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard) jFIFNKLCBLE_);
                jFIFNKLCBLE_ = subBuilder.buildPartial();
              }
              jFIFNKLCBLECase_ = 101;
              break;
            }
            default: {
    ...
    private int jFIFNKLCBLECase_ = 0;
    private java.lang.Object jFIFNKLCBLE_;
    public enum JFIFNKLCBLECase
        implements com.google.protobuf.Internal.EnumLite,
            com.google.protobuf.AbstractMessage.InternalOneOfEnum {
      RESIN_CARD(101),
      JFIFNKLCBLE_NOT_SET(0);
      private final int value;
      private JFIFNKLCBLECase(int value) {
        this.value = value;
      }
      /**
      ...
      public static JFIFNKLCBLECase valueOf(int value) {
        return forNumber(value);
      }

      public static JFIFNKLCBLECase forNumber(int value) {
        switch (value) {
          case 101: return RESIN_CARD;
          case 0: return JFIFNKLCBLE_NOT_SET;
          default: return null;
        }
      }
    ...
    public JFIFNKLCBLECase
    getJFIFNKLCBLECase() {
      return JFIFNKLCBLECase.forNumber(
          jFIFNKLCBLECase_);
    }
    ...
    public emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard getResinCard() {
      if (jFIFNKLCBLECase_ == 101) {
         return (emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard) jFIFNKLCBLE_;
      }
      return emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard.getDefaultInstance();
    }
    /**
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (jFIFNKLCBLECase_ == 101) {
        output.writeMessage(101, (emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard) jFIFNKLCBLE_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (jFIFNKLCBLECase_ == 101) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(101, (emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard) jFIFNKLCBLE_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getJFIFNKLCBLECase().equals(other.getJFIFNKLCBLECase())) return false;
      switch (jFIFNKLCBLECase_) {
        case 101:
          if (!getResinCard()
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct buildPartial() {
        ...
        if (jFIFNKLCBLECase_ == 101) {
          if (resinCardBuilder_ == null) {
            result.jFIFNKLCBLE_ = jFIFNKLCBLE_;
          } else {
            result.jFIFNKLCBLE_ = resinCardBuilder_.build();
          }
        }
        result.jFIFNKLCBLECase_ = jFIFNKLCBLECase_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct other) {
        ...
        switch (other.getJFIFNKLCBLECase()) {
          case RESIN_CARD: {
            mergeResinCard(other.getResinCard());
            break;
          }
          case JFIFNKLCBLE_NOT_SET: {
            break;
          }
        }
        this.mergeUnknownFields(other.unknownFields);
      ...
      public Builder clearJFIFNKLCBLE() {
        jFIFNKLCBLECase_ = 0;
        jFIFNKLCBLE_ = null;
        onChanged();
        return this;
  ...
  checkByteStringIsUtf8(value);
      ...
      public Builder setResinCard(
        ...
        if (resinCardBuilder_ == null) {
          jFIFNKLCBLE_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeResinCard(emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard value) {
        if (resinCardBuilder_ == null) {
          if (jFIFNKLCBLECase_ == 101 &&
              jFIFNKLCBLE_ != emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard.getDefaultInstance()) {
            jFIFNKLCBLE_ = emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard.newBuilder((emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard) jFIFNKLCBLE_)
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCardOrBuilder getResinCardOrBuilder() {
        if ((jFIFNKLCBLECase_ == 101) && (resinCardBuilder_ != null)) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (resinCardBuilder_ == null) {
          ...
          resinCardBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard, emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard.Builder, emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCardOrBuilder>(
                  (emu.grasscutter.net.proto.ShopCardProductOuterClass.ShopCardProduct.ResinCard) jFIFNKLCBLE_,
                  getParentForChildren(),
                  isClean());
          jFIFNKLCBLE_ = null;
        }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\022\n\nprice_tier\030\002 \001(\t\022\032\n\022remain_reward_da" +
      "ys\030\006 \001(\r\022\025\n\rhcoin_per_day\030\004 \001(\r\022\014\n\004days\030" +
      "\005 \001(\r\022\031\n\021card_product_type\030\007 \001(\r\022\022\n\nmcoi" +
      "n_base\030\003 \001(\r\0220\n\nresin_card\030e \001(\0132\032.ShopC" +
    ...
    internal_static_ShopCardProduct_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ShopCardProduct_descriptor,
        new java.lang.String[] { "ProductId", "PriceTier", "RemainRewardDays", "HcoinPerDay", "Days", "CardProductType", "McoinBase", "ResinCard", "JFIFNKLCBLE", });
    internal_static_ShopCardProduct_ResinCard_descriptor =
