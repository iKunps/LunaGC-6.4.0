...
public final class GetMailItemRspOuterClass {
  ...
  public interface GetMailItemRspOrBuilder extends
    ...
    /**
     * <code>repeated .ItemHint beyond_item_hint = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BEYOND_ITEM_HINT_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < beyondItemHint_.size(); i++) {
        output.writeMessage(4, beyondItemHint_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < beyondItemHint_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, beyondItemHint_.get(i));
      }
      for (int i = 0; i < itemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public int hashCode() {
      ...
      if (getBeyondItemHintCount() > 0) {
        hash = (37 * hash) + BEYOND_ITEM_HINT_FIELD_NUMBER;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\032\016ItemHint.proto\"|\n\016GetMailItemRsp\022#\n\020be" +
      "yond_item_hint\030\004 \003(\0132\t.ItemHint\022\024\n\014mail_" +
      "id_list\030\r \003(\r\022\036\n\titem_list\030\006 \003(\0132\013.Equip" +
    ...
    internal_static_GetMailItemRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GetMailItemRsp_descriptor,
        new java.lang.String[] { "BeyondItemHint", "MailIdList", "ItemList", "Retcode", });
    emu.grasscutter.net.proto.EquipParamOuterClass.getDescriptor();
    emu.grasscutter.net.proto.ItemHintOuterClass.getDescriptor();
  }
