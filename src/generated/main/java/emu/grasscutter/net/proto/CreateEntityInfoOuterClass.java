...
public final class CreateEntityInfoOuterClass {
  ...
  public interface CreateEntityInfoOrBuilder extends
    ...
    public emu.grasscutter.net.proto.CreateEntityInfoOuterClass.CreateEntityInfo.HCLEBCJPJPJCase getHCLEBCJPJPJCase();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 106: {
              ...
              if (hCLEBCJPJPJCase_ == 13) {
                subBuilder = ((emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo) hCLEBCJPJPJ_).toBuilder();
              }
              hCLEBCJPJPJ_ =
                  input.readMessage(emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo) hCLEBCJPJPJ_);
                hCLEBCJPJPJ_ = subBuilder.buildPartial();
              }
              hCLEBCJPJPJCase_ = 13;
              break;
            }
    ...
    private int hCLEBCJPJPJCase_ = 0;
    private java.lang.Object hCLEBCJPJPJ_;
    public enum HCLEBCJPJPJCase
        implements com.google.protobuf.Internal.EnumLite,
            com.google.protobuf.AbstractMessage.InternalOneOfEnum {
      GADGET(13),
      HCLEBCJPJPJ_NOT_SET(0);
      private final int value;
      private HCLEBCJPJPJCase(int value) {
        this.value = value;
      }
      /**
      ...
      public static HCLEBCJPJPJCase valueOf(int value) {
        return forNumber(value);
      }

      public static HCLEBCJPJPJCase forNumber(int value) {
        switch (value) {
          case 13: return GADGET;
          case 0: return HCLEBCJPJPJ_NOT_SET;
          default: return null;
        }
      }
    ...
    public HCLEBCJPJPJCase
    getHCLEBCJPJPJCase() {
      return HCLEBCJPJPJCase.forNumber(
          hCLEBCJPJPJCase_);
    }
    ...
    public emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo getGadget() {
      if (hCLEBCJPJPJCase_ == 13) {
         return (emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo) hCLEBCJPJPJ_;
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (hCLEBCJPJPJCase_ == 13) {
        output.writeMessage(13, (emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo) hCLEBCJPJPJ_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (hCLEBCJPJPJCase_ == 13) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, (emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo) hCLEBCJPJPJ_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getHCLEBCJPJPJCase().equals(other.getHCLEBCJPJPJCase())) return false;
      switch (hCLEBCJPJPJCase_) {
        case 13:
          if (!getGadget()
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.CreateEntityInfoOuterClass.CreateEntityInfo buildPartial() {
        ...
        if (hCLEBCJPJPJCase_ == 13) {
          if (gadgetBuilder_ == null) {
            result.hCLEBCJPJPJ_ = hCLEBCJPJPJ_;
          } else {
            result.hCLEBCJPJPJ_ = gadgetBuilder_.build();
          }
        }
        if (entityCase_ == 1) {
        ...
        result.hCLEBCJPJPJCase_ = hCLEBCJPJPJCase_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.CreateEntityInfoOuterClass.CreateEntityInfo other) {
        ...
        switch (other.getHCLEBCJPJPJCase()) {
          case GADGET: {
            mergeGadget(other.getGadget());
            break;
          }
          case HCLEBCJPJPJ_NOT_SET: {
            break;
          }
        }
      ...
      public Builder clearHCLEBCJPJPJ() {
        hCLEBCJPJPJCase_ = 0;
        hCLEBCJPJPJ_ = null;
        onChanged();
        return this;
      ...
      public Builder setGadget(
        ...
        if (gadgetBuilder_ == null) {
          hCLEBCJPJPJ_ = builderForValue.build();
          onChanged();
        } else {
      ...
      public Builder mergeGadget(emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo value) {
        if (gadgetBuilder_ == null) {
          if (hCLEBCJPJPJCase_ == 13 &&
              hCLEBCJPJPJ_ != emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo.getDefaultInstance()) {
            hCLEBCJPJPJ_ = emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo.newBuilder((emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo) hCLEBCJPJPJ_)
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder getGadgetOrBuilder() {
        if ((hCLEBCJPJPJCase_ == 13) && (gadgetBuilder_ != null)) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (gadgetBuilder_ == null) {
          ...
          gadgetBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo, emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder, emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder>(
                  (emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.CreateGadgetInfo) hCLEBCJPJPJ_,
                  getParentForChildren(),
                  isClean());
          hCLEBCJPJPJ_ = null;
        }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fo.proto\032\014Vector.proto\"\230\002\n\020CreateEntityI" +
      ...
      "\001(\r\022#\n\006gadget\030\r \001(\0132\021.CreateGadgetInfoH\000" +
      "\022\024\n\nmonster_id\030\001 \001(\rH\001\022\021\n\007item_id\030\004 \001(\rH" +
      "\001\022\020\n\006npc_id\030\002 \001(\rH\001\022\023\n\tgadget_id\030\003 \001(\rH\001" +
      "B\r\n\013HCLEBCJPJPJB\010\n\006entityB\033\n\031emu.grasscu" +
    ...
    internal_static_CreateEntityInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_CreateEntityInfo_descriptor,
        new java.lang.String[] { "Rot", "Pos", "ClientUniqueId", "RoomId", "SceneId", "Level", "Gadget", "MonsterId", "ItemId", "NpcId", "GadgetId", "HCLEBCJPJPJ", "Entity", });
    emu.grasscutter.net.proto.CreateGadgetInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
