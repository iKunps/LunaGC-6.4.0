...
public final class SceneEntitiesMovesRspOuterClass {
  ...
  public interface SceneEntitiesMovesRspOrBuilder extends
    ...
    /**
     * <code>repeated .EntityMoveFailInfo entity_move_fail_info_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ENTITY_MOVE_FAIL_INFO_LIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < entityMoveFailInfoList_.size(); i++) {
        output.writeMessage(2, entityMoveFailInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < entityMoveFailInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, entityMoveFailInfoList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\0227\n\032entity_move_fail_info_list\030\002 \003(\0132\023.E" +
