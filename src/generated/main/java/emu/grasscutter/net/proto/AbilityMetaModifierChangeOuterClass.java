...
public final class AbilityMetaModifierChangeOuterClass {
  ...
  public interface AbilityMetaModifierChangeOrBuilder extends
    ...
    /**
     * <code>.AbilityString parent_ability_name = 9;</code>
    ...
    /**
     * <code>uint32 apply_entity_id = 11;</code>
     ...
     * </pre>
     *
     * <code>bool is_attached_parent_ability = 13;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PARENT_ABILITY_NAME_FIELD_NUMBER = 9;
    ...
    public static final int APPLY_ENTITY_ID_FIELD_NUMBER = 11;
    ...
    public static final int IS_ATTACHED_PARENT_ABILITY_FIELD_NUMBER = 13;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (parentAbilityName_ != null) {
        output.writeMessage(9, getParentAbilityName());
      }
      for (int i = 0; i < properties_.size(); i++) {
        output.writeMessage(10, properties_.get(i));
      }
      if (applyEntityId_ != 0) {
        output.writeUInt32(11, applyEntityId_);
      }
      if (isAttachedParentAbility_ != false) {
        output.writeBool(13, isAttachedParentAbility_);
      }
      if (serverBuffUid_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (parentAbilityName_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, getParentAbilityName());
      }
      for (int i = 0; i < properties_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (applyEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, applyEntityId_);
      }
      if (isAttachedParentAbility_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(13, isAttachedParentAbility_);
      }
      if (serverBuffUid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e\022%\n\nproperties\030\n \003(\0132\021.ModifierProperty" +
      "\022+\n\023parent_ability_name\030\t \001(\0132\016.AbilityS" +
      "tring\022/\n\027parent_ability_override\030\006 \001(\0132\016" +
      ".AbilityString\022=\n\033attached_instanced_mod" +
      "ifier\030\017 \001(\0132\030.AbilityAttachedModifier\022\031\n" +
      "\021modifier_local_id\030\005 \001(\005\022\027\n\017server_buff_" +
      "uid\030\016 \001(\r\022\027\n\017apply_entity_id\030\013 \001(\r\022\037\n\006ac" +
      "tion\030\003 \001(\0162\017.ModifierAction\022\"\n\032is_attach" +
      "ed_parent_ability\030\r \001(\010B\033\n\031emu.grasscutt" +
    ...
    internal_static_AbilityMetaModifierChange_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityMetaModifierChange_descriptor,
        new java.lang.String[] { "Properties", "ParentAbilityName", "ParentAbilityOverride", "AttachedInstancedModifier", "ModifierLocalId", "ServerBuffUid", "ApplyEntityId", "Action", "IsAttachedParentAbility", });
    emu.grasscutter.net.proto.AbilityAttachedModifierOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AbilityStringOuterClass.getDescriptor();
    emu.grasscutter.net.proto.ModifierActionOuterClass.getDescriptor();
    emu.grasscutter.net.proto.ModifierPropertyOuterClass.getDescriptor();
