...
public final class SetCodexPushtipsReadRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CODEX_ID_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (codexId_ != 0) {
        output.writeUInt32(4, codexId_);
      }
      if (typeId_ != 0) {
        output.writeUInt32(7, typeId_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (codexId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, codexId_);
      }
      if (typeId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, typeId_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "dexPushtipsReadRsp\022\017\n\007type_id\030\007 \001(\r\022\017\n\007r" +
      "etcode\030\003 \001(\005\022\020\n\010codex_id\030\004 \001(\rB\033\n\031emu.gr" +
