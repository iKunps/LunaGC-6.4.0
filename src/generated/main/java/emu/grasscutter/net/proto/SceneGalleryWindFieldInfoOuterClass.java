...
public final class SceneGalleryWindFieldInfoOuterClass {
  ...
  /**
   * <pre>
   * uint32 ECEIPGJIJME = 4;
   * uint32 LHKAEGNEBHF = 3;
   * uint32 IKNLGEAECKL = 10;
   * uint32 IGALADAKNPN = 15;
   * uint32 GNFMHGBJMIA = 5;
   * uint32 ODOFAMEIIGE = 2;
   * uint32 AFPDOHOCHCP = 7;
   * uint32 IMKDIIBPNOO = 9;
   * </pre>
   *
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\037SceneGalleryWindFieldInfo.proto\"\033\n\031Sce" +
      "neGalleryWindFieldInfoB\033\n\031emu.grasscutte" +
