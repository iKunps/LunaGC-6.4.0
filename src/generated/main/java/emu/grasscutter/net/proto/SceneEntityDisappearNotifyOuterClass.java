...
public final class SceneEntityDisappearNotifyOuterClass {
  ...
  public interface SceneEntityDisappearNotifyOrBuilder extends
    ...
    /**
     * <code>repeated uint32 entity_list = 4;</code>
    ...
    /**
     * <code>.VisionType disappear_type = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ENTITY_LIST_FIELD_NUMBER = 4;
    ...
    public static final int DISAPPEAR_TYPE_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (disappearType_ != emu.grasscutter.net.proto.VisionTypeOuterClass.VisionType.VisionType_VISION_NONE.getNumber()) {
        output.writeEnum(3, disappearType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (disappearType_ != emu.grasscutter.net.proto.VisionTypeOuterClass.VisionType.VisionType_VISION_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(3, disappearType_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < entityList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fy\022\023\n\013entity_list\030\004 \003(\r\022\r\n\005param\030\014 \001(\r\022#" +
      "\n\016disappear_type\030\003 \001(\0162\013.VisionTypeB\033\n\031e" +
