...
public final class VehicleStaminaNotifyOuterClass {
  ...
  public interface VehicleStaminaNotifyOrBuilder extends
    ...
    /**
     * <code>float cur_stamina = 11;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CUR_STAMINA_FIELD_NUMBER = 11;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (curStamina_ != 0F) {
        output.writeFloat(11, curStamina_);
      }
      if (entityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (curStamina_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(11, curStamina_);
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
