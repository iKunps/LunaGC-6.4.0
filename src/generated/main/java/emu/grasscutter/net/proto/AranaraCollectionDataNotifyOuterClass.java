...
public final class AranaraCollectionDataNotifyOuterClass {
  ...
  public interface AranaraCollectionDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .AranaraCollectionSuite collection_suite_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int COLLECTION_SUITE_LIST_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < collectionSuiteList_.size(); i++) {
        output.writeMessage(1, collectionSuiteList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < collectionSuiteList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, collectionSuiteList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t\030\001 \003(\0132\027.AranaraCollectionSuiteB\033\n\031emu." +
