...
public final class AISnapshotInfoOuterClass {
  ...
  public interface AISnapshotInfoOrBuilder extends
    ...
    /**
     * <code>repeated .AISnapshotEntityData ai_snapshots = 8;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AI_SNAPSHOTS_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < aiSnapshots_.size(); i++) {
        output.writeMessage(8, aiSnapshots_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < aiSnapshots_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, aiSnapshots_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "hots\030\010 \003(\0132\025.AISnapshotEntityDataB\033\n\031emu" +
