...
public final class GetAllH5ActivityInfoRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < h5ActivityInfoList_.size(); i++) {
        output.writeMessage(4, h5ActivityInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < h5ActivityInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, h5ActivityInfoList_.get(i));
      }
      if (clientRedDotTimestamp_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022.\n\025h5_activity_info_list\030\004 \003(\0132\017.H5Acti" +
      "vityInfo\022\017\n\007retcode\030\001 \001(\005\022 \n\030client_red_" +
      "dot_timestamp\030\016 \001(\rB\033\n\031emu.grasscutter.n" +
      "et.protob\006proto3"
    };
