...
public final class PlayerInvestigationAllInfoNotifyOuterClass {
  ...
  public interface PlayerInvestigationAllInfoNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .Investigation investigation_list = 15;</code>
     */
    ...
    /**
     * <code>repeated .InvestigationTarget investigation_target_list = 8;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int INVESTIGATION_LIST_FIELD_NUMBER = 15;
    ...
    public static final int INVESTIGATION_TARGET_LIST_FIELD_NUMBER = 8;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < investigationTargetList_.size(); i++) {
        output.writeMessage(8, investigationTargetList_.get(i));
      }
      for (int i = 0; i < investigationList_.size(); i++) {
        output.writeMessage(15, investigationList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < investigationTargetList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, investigationTargetList_.get(i));
      }
      for (int i = 0; i < investigationList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(15, investigationList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "otify\022*\n\022investigation_list\030\017 \003(\0132\016.Inve" +
      "stigation\0227\n\031investigation_target_list\030\010" +
