...
public final class FireworksReformDataOuterClass {
  ...
  public interface FireworksReformDataOrBuilder extends
    ...
    /**
     * <code>repeated .FireworksReformParam reform_param_list = 4;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int REFORM_PARAM_LIST_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < reformParamList_.size(); i++) {
        output.writeMessage(4, reformParamList_.get(i));
      }
      if (id_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < reformParamList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, reformParamList_.get(i));
      }
      if (id_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\021reform_param_list\030\004 \003(\0132\025.FireworksRef" +
