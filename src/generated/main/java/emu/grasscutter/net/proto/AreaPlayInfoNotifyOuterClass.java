...
public final class AreaPlayInfoNotifyOuterClass {
  ...
  public interface AreaPlayInfoNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 detail_play_type = 8;</code>
     * @return The detailPlayType.
     */
    int getDetailPlayType();

    /**
     * <code>.AreaPlayType area_play_type = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DETAIL_PLAY_TYPE_FIELD_NUMBER = 8;
    ...
    public static final int AREA_PLAY_TYPE_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (areaPlayType_ != emu.grasscutter.net.proto.AreaPlayTypeOuterClass.AreaPlayType.AreaPlayType_AREA_PLAY_NONE.getNumber()) {
        output.writeEnum(3, areaPlayType_);
      }
      if (detailPlayType_ != 0) {
        output.writeUInt32(8, detailPlayType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (areaPlayType_ != emu.grasscutter.net.proto.AreaPlayTypeOuterClass.AreaPlayType.AreaPlayType_AREA_PLAY_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(3, areaPlayType_);
      }
      if (detailPlayType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, detailPlayType_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "lay_type\030\010 \001(\r\022%\n\016area_play_type\030\003 \001(\0162\r" +
