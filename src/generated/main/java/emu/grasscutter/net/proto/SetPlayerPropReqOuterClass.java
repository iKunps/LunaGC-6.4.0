...
public final class SetPlayerPropReqOuterClass {
  ...
  public interface SetPlayerPropReqOrBuilder extends
    ...
    /**
     * <code>repeated .PropValue prop_list = 12;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PROP_LIST_FIELD_NUMBER = 12;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < propList_.size(); i++) {
        output.writeMessage(12, propList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < propList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, propList_.get(i));
      }
