...
public final class WinterCampAcceptAllGiveItemRspOuterClass {
  ...
  public interface WinterCampAcceptAllGiveItemRspOrBuilder extends
    ...
    /**
     * <code>repeated .WinterCampAcceptItemResultInfo accept_item_result_info = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ACCEPT_ITEM_RESULT_INFO_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < acceptItemResultInfo_.size(); i++) {
        output.writeMessage(6, acceptItemResultInfo_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < acceptItemResultInfo_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, acceptItemResultInfo_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_item_result_info\030\006 \003(\0132\037.WinterCampAcce" +
